...
import navbarimage from '@pages/admin/assets/img/layout/Navbar.png'
...
const Navbar = (props) => {
  ...
  const nameAdmin = JSON.parse(localStorage.getItem('userInfo')) || []
            ...
            <div className='flex w-56 flex-col justify-start rounded-[20px] bg-white bg-cover bg-no-repeat shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:text-white dark:shadow-none'>
              <div className='p-4'>
                <div className='flex items-center gap-2 '>
                  <p className='text-sm font-bold text-navy-700 dark:text-white text-center w-full'>
                    👋 {nameAdmin.name} 👋
                  </p>
                </div>
              </div>
